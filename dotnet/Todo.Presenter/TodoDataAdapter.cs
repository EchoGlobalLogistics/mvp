...
{
    class TodoDataAdapter : ITodoPersistor<TodoItem>
    {
        private readonly TodoPersistor _persistor;

        private static TodoDataAdapter _instance;

        private TodoDataAdapter()
        {
            _persistor = new TodoPersistor();
        }

        public static TodoDataAdapter Instance 
        {
            get
            {
                return _instance ?? (_instance = new TodoDataAdapter());
            }
        }
